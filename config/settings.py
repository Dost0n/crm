...
SECRET_KEY = config("SECRET_KEY", cast=str,
                    default='django-insecure-(t^)+uqx*k0^ma^vq+vg1zs1rk@!12%^&m$o)de$!d(z8phn=m')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config("DEBUG", cast=bool, default=True)

DEVELOPMENT = config("DEVELOPMENT", cast=bool, default=True)
...
#     "CORS_ALLOWED_ORIGINS", cast=str, default="*").split(",")
